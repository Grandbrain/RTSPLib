...
/// \brief Contains declarations of utilities for calculating checksums.
/// \bug No known bugs.
...
/// A namespace that contains utilities for calculating checksums.
namespace Utilities::Checksum {
